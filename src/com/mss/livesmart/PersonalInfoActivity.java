...
public class PersonalInfoActivity extends FragmentActivity implements
		EditDateOfBirthDialog.OnCompleteListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		res = getResources();
		settings = getSharedPreferences(res.getString(R.string.personal_info),
				0);
		...
		spinnerGender.setSelection(settings.getInt(
				res.getString(R.string.gender_spinner_value), 0));
		...
		txtWeight.setText(settings.getString(
				res.getString(R.string.weight_in_kilogram), "60"));

		txtHeight = (EditText) findViewById(R.id.txtHeight);
		txtHeight.setText(settings.getString(
				res.getString(R.string.height_in_centemeter), "170"));

		hypertensionCbx = (CheckBox) findViewById(R.id.HypertensionCbx);
		hypertensionCbx.setChecked(settings.getBoolean(
				res.getString(R.string.Hypertension), false));

		insomniaCbx = (CheckBox) findViewById(R.id.InsomniaCbx);
		insomniaCbx.setChecked(settings.getBoolean(
				res.getString(R.string.Insomnia), false));

		diabetesCbx = (CheckBox) findViewById(R.id.DiabtetesCbx);
		diabetesCbx.setChecked(settings.getBoolean(
				res.getString(R.string.Diabetes), false));

		cardioCbx = (CheckBox) findViewById(R.id.CardioCbx);
		cardioCbx.setChecked(settings.getBoolean(
				res.getString(R.string.Cardio), false));
	...
	public void savePersonalInfo() {
		...
		editor.putInt(res.getString(R.string.gender_spinner_value),
				spinnerGender.getSelectedItemPosition());
		editor.putString(res.getString(R.string.Gender),
				getGender(spinnerGender.getSelectedItemPosition()));
		editor.putString(res.getString(R.string.weight_in_kilogram), txtWeight
				.getText().toString());
		editor.putString(res.getString(R.string.height_in_centemeter),
		...
		editor.putBoolean(res.getString(R.string.Hypertension),
				hypertensionCbx.isChecked());
		editor.putBoolean(res.getString(R.string.Insomnia),
				insomniaCbx.isChecked());
		editor.putBoolean(res.getString(R.string.Cardio), cardioCbx.isChecked());
		editor.putBoolean(res.getString(R.string.Diabetes),
				diabetesCbx.isChecked());

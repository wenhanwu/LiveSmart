...
public class HealthHistoryActivityDemoPerson3 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        graphDisplayArea = (LinearLayout) view.findViewById(R.id.graphActivity3);
        ...
        for(int i = 0; i < weekly; i++) {
            sleepData[i] = new GraphViewData(i, SampleHealthData.getHealthData().getSleep().get(i+biweekly).getMinutesAsleep()/60);
            stepsData[i] = new GraphViewData(i, SampleHealthData.getHealthData().getActivities().get(i+biweekly).getDuration());
        }
        ...
        for(int i=0; i < biweekly; i++) {
            bpSystolicData[i] = new GraphViewData(i, SampleHealthData.getHealthData().getBloodPressures().get(i+biweekly*2).getSystolic());
            bpDiastolicData[i] = new GraphViewData(i, SampleHealthData.getHealthData().getBloodPressures().get(i+biweekly*2).getDiastolic());
        ...
        graphViewStep.setHorizontalLabels(new String[] {"Apr 15"," ", " ", "Apr 21"});
        ...
        graphViewSleep.setHorizontalLabels(new String[] {"Apr 15"," ", " ", "Apr 21"});
        ...
        graphViewBp.setHorizontalLabels(new String[] {"Apr 15"," ", " ", "Apr 21"});

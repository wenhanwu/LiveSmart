...
public class HealthHistoryActivityDemoPerson2 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        graphDisplayArea = (LinearLayout) view.findViewById(R.id.graphActivity2);
        ...
        for(int i = 0; i < weekly; i++) {
            sleepData[i] = new GraphViewData(i, SampleHealthData.getHealthData().getSleep().get(i+weekly).getMinutesAsleep()/60);
            stepsData[i] = new GraphViewData(i, SampleHealthData.getHealthData().getActivities().get(i+weekly).getDuration());
        }
        ...
        for(int i=0; i < biweekly; i++) {
            bpSystolicData[i] = new GraphViewData(i, SampleHealthData.getHealthData().getBloodPressures().get(i+biweekly).getSystolic());
            bpDiastolicData[i] = new GraphViewData(i, SampleHealthData.getHealthData().getBloodPressures().get(i+biweekly).getDiastolic());
        ...
        graphViewStep.setHorizontalLabels(new String[] {"Apr 8"," ", " ", "Apr 14"});
        ...
        graphViewSleep.setHorizontalLabels(new String[] {"Apr 8"," ", " ", "Apr 14"});
        ...
        graphViewBp.setHorizontalLabels(new String[] {"Apr 8"," ", " ", "Apr 14"});
